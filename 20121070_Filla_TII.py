...
data_mahasiswa  = {
    'NIM' : '20121070' ,
    'Nama' : 'Filla Firontina' ,
    'Kelas' : 'TI3A' ,
    'Alamat' : 'Wonotunggal Batang'
}
...
cetak ( kalimat [ 4 ], kalimat [ 9 ], kalimat [ 17 ], kalimat [ 1 ], kalimat [ 0 ], kalimat [ 16 ], kalimat [ 2 ], kalimat [ 8 ], kalimat [ 5 ], kalimat [ 3 ], kalimat [ 6 ], kalimat [ 7 ], kalimat [ 15 ],kalimat [ 10 ], kalimat [ 12 ], kalimat [ 13 ], kalimat [ 11 ])
